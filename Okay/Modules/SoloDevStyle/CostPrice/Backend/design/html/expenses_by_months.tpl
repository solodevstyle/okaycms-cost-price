    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            ...
            <div class="box_btn_heading">
              <a class="btn btn_small btn-info" href="{url controller=[SoloDevStyle,CostPrice,ExpensesByMonthAdmin] return=$smarty.server.REQUEST_URI}">
                            ...
                            <div class="fn_row okay_list_body_item fn_sort_item">
                                <div class="okay_list_row">
                                    ...
                                    <div class="okay_list_boding okay_list_expenses_month_name">
                                        <a class="link" href="{url controller=[SoloDevStyle,CostPrice,ExpensesByMonthAdmin] id=$expense->id return=$smarty.server.REQUEST_URI}">
                                            {$expense->date|escape}
                                        </a>
                                    </div>
