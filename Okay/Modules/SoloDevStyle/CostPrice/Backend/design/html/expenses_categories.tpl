    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            ...
            <div class="box_btn_heading">
              <a class="btn btn_small btn-info" href="{url controller=[SoloDevStyle,CostPrice,ExpensesCategoryAdmin] return=$smarty.server.REQUEST_URI}">
                            ...
                            <div class="fn_row okay_list_body_item fn_sort_item">
                                <div class="okay_list_row">
                                    ...
                                    <div class="okay_list_boding okay_list_expenses_category_name">
                                        <a class="link" href="{url controller=[SoloDevStyle,CostPrice,ExpensesCategoryAdmin] id=$category->id return=$smarty.server.REQUEST_URI}">
                                    ...
                                    <div class="okay_list_boding okay_list_status">
                                        ...
                                        <label class="switch switch-default">
                                            <input class="switch-input fn_ajax_action {if $category->visible}fn_active_class{/if}" data-controller="solo_dev_style__expenses_category" data-action="visible" data-id="{$category->id}" name="visible" value="1" type="checkbox"  {if $category->visible}checked=""{/if}/>
