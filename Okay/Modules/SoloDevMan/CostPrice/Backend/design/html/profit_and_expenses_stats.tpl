    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            ...
            <div class="box_btn_heading">
                <a class="export_block export_users hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-hint="Налаштування категорій витрат" href="{url controller=[SoloDevMan,CostPrice,ExpensesCategoriesAdmin] return=$smarty.server.REQUEST_URI}">
                ...
                <a class="export_block export_users hint-bottom-middle-t-info-s-small-mobile  hint-anim" data-hint="Керування витратами" href="{url controller=[SoloDevMan,CostPrice,ExpensesByMonthsAdmin] return=$smarty.server.REQUEST_URI}">
