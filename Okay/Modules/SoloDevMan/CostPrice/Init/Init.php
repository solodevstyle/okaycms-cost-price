...
namespace Okay\Modules\SoloDevMan\CostPrice\Init;
...
{
    const PERMISSION = 'sdm_cost_price';
    ...
    public function init()
    {
        ...
        $this->extendBackendMenu('left_stats', [
            'sdm_profit_and_expenses__title' => ['ProfitAndExpensesStatsAdmin','ExpensesCategoriesAdmin','ExpensesCategoryAdmin','ExpensesByMonthsAdmin','ExpensesByMonthAdmin'],
        ]);

        $this->extendUpdateObject('solo_dev_man__expenses_category', self::PERMISSION, ExpensesCategoriesEntity::class);
    }
